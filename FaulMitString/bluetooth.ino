  ...
  if (recievedFlag) {     // если получены данные
    ...
    switch (intData[0]) {
      ...
      case 6: // авто
        ...
        break;
      case 7: // НОВОЕ: прямой RGB
        rgbR = intData[1];
        rgbG = intData[2];
        rgbB = intData[3];
        useRGB = true;       // теперь рисуем текст этим цветом
        break;
      case 8: // CLEAR: очистить текст и выключить бегущую строку
        runningText = "";
        thisLength = 0;
        showText = false;
        loadingFlag = true;   // чтобы строка, если что, начала заново после нового текста
        strip.clear();
        strip.show();
        break;
    }
